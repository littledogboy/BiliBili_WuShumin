...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(![dictionary[@"attribute"] isKindOfClass:[NSNull class]]){
		self.attribute = [dictionary[@"attribute"] integerValue];
	}
	...
	if(![dictionary[@"ctime"] isKindOfClass:[NSNull class]]){
		self.ctime = [dictionary[@"ctime"] integerValue];
	}
	...
	if(![dictionary[@"elec"] isKindOfClass:[NSNull class]]){
		self.elec = [[Elec alloc] initWithDictionary:dictionary[@"elec"]];
	}
	...
	if(![dictionary[@"owner_ext"] isKindOfClass:[NSNull class]]){
		self.ownerExt = [[OwnerExt alloc] initWithDictionary:dictionary[@"owner_ext"]];
	}
	...
	if(![dictionary[@"tid"] isKindOfClass:[NSNull class]]){
		self.tid = [dictionary[@"tid"] integerValue];
	}
...
-(NSDictionary *)toDictionary
{
	...
	dictionary[@"attribute"] = @(self.attribute);
	dictionary[@"copyright"] = @(self.copyright);
	dictionary[@"ctime"] = @(self.ctime);
	if(self.desc != nil){
		dictionary[@"desc"] = self.desc;
	}
	dictionary[@"duration"] = @(self.duration);
	if(self.elec != nil){
		dictionary[@"elec"] = [self.elec toDictionary];
	}
	if(self.owner != nil){
		dictionary[@"owner"] = [self.owner toDictionary];
	}
	if(self.ownerExt != nil){
		dictionary[@"owner_ext"] = [self.ownerExt toDictionary];
	}
	if(self.pages != nil){
...
{
	[aCoder encodeObject:@(self.aid) forKey:@"aid"];	[aCoder encodeObject:@(self.attribute) forKey:@"attribute"];	[aCoder encodeObject:@(self.copyright) forKey:@"copyright"];	[aCoder encodeObject:@(self.ctime) forKey:@"ctime"];	if(self.desc != nil){
		[aCoder encodeObject:self.desc forKey:@"desc"];
	}
	[aCoder encodeObject:@(self.duration) forKey:@"duration"];	if(self.elec != nil){
		[aCoder encodeObject:self.elec forKey:@"elec"];
	}
	if(self.owner != nil){
		[aCoder encodeObject:self.owner forKey:@"owner"];
	}
	if(self.ownerExt != nil){
		[aCoder encodeObject:self.ownerExt forKey:@"owner_ext"];
	}
	if(self.pages != nil){
	...
	[aCoder encodeObject:@(self.state) forKey:@"state"];	if(self.tags != nil){
		[aCoder encodeObject:self.tags forKey:@"tags"];
	}
	[aCoder encodeObject:@(self.tid) forKey:@"tid"];	if(self.title != nil){
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
	...
	self.attribute = [[aDecoder decodeObjectForKey:@"attribute"] integerValue];
	self.copyright = [[aDecoder decodeObjectForKey:@"copyright"] integerValue];
	self.ctime = [[aDecoder decodeObjectForKey:@"ctime"] integerValue];
	self.desc = [aDecoder decodeObjectForKey:@"desc"];
	self.duration = [[aDecoder decodeObjectForKey:@"duration"] integerValue];
	self.elec = [aDecoder decodeObjectForKey:@"elec"];
	self.owner = [aDecoder decodeObjectForKey:@"owner"];
	self.ownerExt = [aDecoder decodeObjectForKey:@"owner_ext"];
	...
	self.tid = [[aDecoder decodeObjectForKey:@"tid"] integerValue];
