...
@interface BungumiSerializing ()
@end
@implementation BungumiSerializing
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(![dictionary[@"is_started"] isKindOfClass:[NSNull class]]){
		self.isStarted = [dictionary[@"is_started"] integerValue];
	}
...
-(NSDictionary *)toDictionary
{
	...
	dictionary[@"is_started"] = @(self.isStarted);
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
	...
	[aCoder encodeObject:@(self.isFinish) forKey:@"is_finish"];	[aCoder encodeObject:@(self.isStarted) forKey:@"is_started"];	[aCoder encodeObject:@(self.lastTime) forKey:@"last_time"];	if(self.newestEpIndex != nil){
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
	...
	self.isStarted = [[aDecoder decodeObjectForKey:@"is_started"] integerValue];
