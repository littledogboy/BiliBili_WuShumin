...
#import "LiveRecommendBannerData.h"

@interface LiveRecommendBannerData ()
@end
@implementation LiveRecommendBannerData
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(![dictionary[@"cover"] isKindOfClass:[NSNull class]]){
		self.cover = [[LiveRecommendCover alloc] initWithDictionary:dictionary[@"cover"]];
	}
	...
	if(![dictionary[@"owner"] isKindOfClass:[NSNull class]]){
		self.owner = [[LiveRecommendOwner alloc] initWithDictionary:dictionary[@"owner"]];
	}
