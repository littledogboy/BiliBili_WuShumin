...
@interface LiveRecommendRootClass ()
@end
@implementation LiveRecommendRootClass
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(![dictionary[@"data"] isKindOfClass:[NSNull class]]){
		self.data = [[LiveRecommendData alloc] initWithDictionary:dictionary[@"data"]];
	}
